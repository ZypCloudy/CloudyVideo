...
//                Toast.makeText(SystemVideoPlayer.this, "我被单击了", Toast.LENGTH_SHORT).show();
    ...
    private void showMediaController() {
        ...
        //影藏中间的声音控件
        ll_vioce.setVisibility(View.GONE);
...
//        screenHeight = getWindowManager().getDefaultDisplay().getHeight();
    ...
    private void findViews() {
        ...
        ll_vioce = (LinearLayout) findViewById(R.id.ll_vioce);
...
//                    Toast.makeText(SystemVideoPlayer.this, "卡结束了", Toast.LENGTH_SHORT).show();
    ...
    private void updataVoice(int progress, boolean isMute) {
        if (isMute) {
            ...
            btnVoice.setBackgroundResource(R.drawable.btn_voice_pressed);
        } else {
            am.setStreamVolume(AudioManager.STREAM_MUSIC, progress, 0);
            seekbarVoice.setProgress(progress);
            currentVoice = progress;
            btnVoice.setBackgroundResource(R.drawable.btn_voice_normal);
        }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE://手指移动
                ...
                if (endX < screenWidth / 2) {
                    ...
                    ll_vioce.setVisibility(View.VISIBLE);
